  ...
  return (
    <div className="container mx-auto pb-10">
      <div className="sm:flex ">
        <div className="md:w-4/6 px-10 py-10 overflow-hidden">
      ...
      <Link href="/productlist" className="flex font-semibold text-orange-600 text-sm px-12 -mt-14">
        <svg className="fill-current mr-2 text-orange-500 hover:text-orange-600 w-4" viewBox="0 0 448 512">
