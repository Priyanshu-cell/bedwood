    ...
    <div className="bg-inherit relative group">
      ...
      <Link href={`/product/${product.id}`} className="block">
        ...
        <div className="w-full md:h-[250px] overflow-hidden mx-auto my-4 relative cursor-pointer">
          ...
          {/* Detail Button */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-400 text-white p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
