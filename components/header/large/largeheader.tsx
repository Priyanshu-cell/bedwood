      ...
      <div className="hidden md:flex flex-col items-center">
        <div className="flex items-center justify-between w-full max-w-6xl mx-auto">
          ...
          <div className="flex items-center space-x-4 ml-4">
            ...
            {/* Cart Button */}
            <Link className="flex flex-col items-center justify-center rounded-full" href="/cart">
      ...
      <div className="md:hidden flex flex-col items-center">
        <div className="flex items-center w-full max-w-6xl mx-auto justify-between">
          ...
          <Link className="flex items-center" href="/cart">
            <FaShoppingCart className="text-gray-600 text-xl mr-2" />
          </Link>
        </div>
        ...
        <div className={`fixed inset-0 bg-gray-200 transform overflow-y-auto pb-10 scroll-smooth ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-500 ease-in-out z-50`}>
          <div className="flex items-center pt-4 bg-white">
            ...
            <button className="flex items-center mr-4" onClick={() => setIsSidebarOpen(false)}>
              <HiOutlineArrowLongLeft className="text-gray-600 text-4xl" />
            </button>
